...
public class Config {
  ...
  private void loadConfig() {
    ...
    config.addDefault("Language.Abilities.Spirit.Agility.Description",
    ...
    config.addDefault("Language.Abilities.Spirit.Possess.Description",
    ...
    config.addDefault("Language.Abilities.Spirit.Phase.Description",
    ...
    config.addDefault("Language.Abilities.Spirit.Vanish.Description",
    ...
    config.addDefault("Language.Abilities.LightSpirit.Alleviate.Description",
    ...
    config.addDefault("Language.Abilities.LightSpirit.LightBlast.Instructions",
        "Left-click to shoot the blast ⏐ Tap-shift to select a target then left-click to shoot a different kind of blast.");

    config.addDefault("Language.Abilities.LightSpirit.Rejuvenate.Description",
    ...
    config.addDefault("Language.Abilities.LightSpirit.Orb.Description",
    ...
    config.addDefault("Language.Abilities.LightSpirit.Orb.Instructions",
        "Hold shift until you see particles. Release shift while looking at an area nearby on the ground to plant it there.");

    config.addDefault("Language.Abilities.DarkSpirit.Intoxicate.Description",
    ...
    config.addDefault("Language.Abilities.LightSpirit.Shelter.Description",
    ...
    config.addDefault("Language.Abilities.DarkSpirit.DarkBlast.Description",
    ...
    config.addDefault("Language.Abilities.DarkSpirit.DarkBlast.Instructions",
        "Left click: Quick blast ⏐ Tap-shift while looking at an entity: Select entity > Hold shift: Move the homing blast.");

    config.addDefault("Language.Abilities.DarkSpirit.Infest.Description",
    ...
    config.addDefault("Language.Abilities.DarkSpirit.Shackle.Description",
    ...
    config.addDefault("Language.Abilities.DarkSpirit.Strike.Description",
    ...
    // Purify
    config.addDefault("Language.Abilities.Water.Purify.Description",
    ...
    config.addDefault("Language.Abilities.Water.Purify.Instructions", "Hold shift for 10 seconds while looking at an entity");

    // Corrupt
    config.addDefault("Language.Abilities.Water.Corrupt.Description",
    ...
    config.addDefault("Language.Abilities.Water.Corrupt.Instructions", "Hold shift for 10 seconds while looking at an entity");
