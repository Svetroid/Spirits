...
public class Methods {
  ...
  /**
   * A general animation to display when making a Spirit/Player invisible.
   *
  ...
  /**
   * Used to play particles based on the type of Spirit a player is.
   *
   * @param player   The player being tested.
  ...
  /**
   * Sets the velocity of a player with a height addition.
   *
   * @param target The target being manipulated.
   * @param speed  The speed of the player.
  ...
  /**
   * Used to create a string with the generic Spirits formatting.
   *
